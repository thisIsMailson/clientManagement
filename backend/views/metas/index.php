...
/* @var $searchModel backend\models\MetasSearch */
...
<div class="metas-index">
    ...
    <div class="box">
        ...
        <p style="float: left; margin-bottom: 0px">
                <?= Html::button('Adicionar', ['value'=>URL::to('index.php?r=metas/create'), 'class' => 'btn btn-primary', 'id'=>'contatoButton']) ?>
        </p>
        <br>
        <br>
        <br>
                    ...
                    ['class'=>'kartik\grid\ActionColumn','template'=> '{view}{update}',
                        'buttons' => [
                                ...
                                'update' => function ($url, $model) {
                                 ...
                                 ['value' => $url, 'onclick' => 'js:openPopUp(this);', 'title' => 'Atualizar meta']);
