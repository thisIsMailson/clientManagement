...
/* @var $searchModel backend\models\CanalSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Canais';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="canal-index">
    ...
    <div class="box">
        <div class="box-body">
            ...
            <p style="float: left; margin-bottom: 0px">
                <?= Html::button('Adicionar', ['value'=>URL::to('index.php?r=canal/create'), 'class' => 'btn btn-primary', 'id'=>'contatoButton']) ?>
            </p>
            <br>
            <br>
            <br>   
