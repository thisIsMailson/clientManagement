    ...
    <div class="box">
        <div class="box-body">
            ...
            <p style="float: left; margin-bottom: 0px">
                <?= Html::button('Adicionar', ['value'=>URL::to('index.php?r=notification/create'), 'class' => 'btn btn-primary', 'id'=>'contatoButton']) ?>
            </p>
            <br>
            <br>
            <br>   
            <?= DynaGrid::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        return $model->alvo == 1 ?'Todos':'Gestor apenas';
                        },
                        'width'=>'150px',
                        'pageSummary'=>true
                    ],
                    ...
                    ['class'=>'kartik\grid\ActionColumn','template'=> '{view}{update}',
                        'buttons' => [
                                ...
                                'update' => function ($url, $model) {
                                 ...
                                 ['value' => $url, 'onclick' => 'js:openPopUp(this);', 'title' => 'Editar notificação']);
