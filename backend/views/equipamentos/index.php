...
/* @var $searchModel backend\models\EquipamentosSearch */
    ...
    <div class="box">
        <div class="box-body">
            ...
            <p style="float: left; margin-bottom: 0px">
                <?= Html::button('Adicionar', ['value'=>URL::to('index.php?r=equipamentos/create'), 'class' => 'btn btn-primary', 'id'=>'contatoButton']) ?>
            </p>
            <br>
            <br>
            <br>
