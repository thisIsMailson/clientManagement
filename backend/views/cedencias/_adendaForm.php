              ...
              <div class="panel-body">
                   ...
                   <div class="form-row">
                    <div class="form-group col-md-12">
                        <?php
                            $clientName = $cedencia->nomeCliente;
                            echo $form->field($model, 'nomecli')->textInput(['readonly'=>true, 'value'=>$clientName]) 
                        ?>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <?= $form->field($model, 'dataInicioContrato')->textInput(['readonly'=>'true', 'value'=>$cedencia->dataInicioContrato]) ?>
                    </div>
                    <div class="form-group col-md-4">
                         <?= $form->field($model, 'dataFimContrato')->textInput(['readonly'=>'true', 'value'=>$cedencia->dataFimContrato]) ?>
                    </div>
                    <div class="form-group col-md-4">
                        <?= $form->field($model, 'periodoFidelizacao')->textInput(['readonly'=>'true', 'value'=>$cedencia->periodoFidelizacao]) ?>
                    </div>
                </div>
              </div>
            </div>
        ...
        <div class="panel-group">
            <div class="panel panel-success">
              ...
              <div class="panel-body">
                   ...
                   <div class="form-row">
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'cartoesPosPago')->textInput(['readonly'=>'true', 'value'=>$cedencia->cartoesPosPago]) ?>
                        </div>
                    
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'cartoesPrePago')->textInput(['readonly'=>'true', 'value'=>$cedencia->cartoesPrePago]) ?>
                        </div>
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'totalCartoes')->textInput(['readonly'=>'true', 'value'=>$cedencia->totalCartoes]) ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'valorPosPago')->textInput(['readonly'=>'true', 'value'=>$cedencia->valorPosPago]) ?>
                        </div>
                    
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'valorPrePago')->textInput(['readonly'=>'true', 'value'=>$cedencia->valorPrePago]) ?>
                        </div>
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'total')->textInput(['readonly'=>'true', 'value'=>$cedencia->total]) ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-8">
                            <?php
                                ...
                                $model->servicos = json_decode($cedencia->servicos);
        ...
        <div class="row">
            ...
            <div class="panel-body">
                <div class="container-items"><!-- widgetBody -->
                            ...
                            <div class="item panel panel-default"><!-- widgetItem -->
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <?= $form->field($modelsEquipamento, "[{$i}]PrecoTotal")->textInput(['readonly'=>true, 'type' => 'number', 'min'=>0,  'class'=>'precoTotProd']) ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                 ...
                 <div class="form-row">
                <div class="form-group col-md-4">
                     <?= $form->field($model, 'quantidadeTotal')->textInput(['type'=>'number', 'id'=>'quantidadeTotal', 'min'=>0, 'readonly'=>true]) ?>
                </div>
                <div class="form-group col-md-4">
                    <?= $form->field($model, 'precoTotal')->textInput(['type'=>'number', 'id'=>'precoTotal', 'min'=>0, 'readonly'=>true]) ?>
                </div>
                <div class="form-group col-md-4">
              ...
              <div class="panel-heading">Proposta/Pagamento</div>
                <div class="panel-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                             <?= $form->field($model, 'valorPago')->textInput(['type'=>'number', 'id'=>'field1ID', 'min'=>0]) ?>
                        </div>
                        <div class="form-group col-md-3">
                            <?= $form->field($model, 'valorAdicional')->textInput(['type'=>'number', 'id'=>'field2ID', 'min'=>0]) ?>
                        </div>
                        <div class="form-group col-md-3">
                            <?= $form->field($model, 'totalPropostapagamento')->textInput(['readonly'=> true,'id'=>'resultFieldID', 'min'=>0]) ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3">
                             <?= $form->field($model, 'guiaSaida')->textInput(['type'=>'number', 'maxlength' => true, 'min'=>0]) ?>
                        </div>
