              ...
              <div class="panel-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <?= $form->field($model, 'dataInicioContrato')->textInput(['readonly'=>'true', 'value'=>$model->dataInicioContrato]) ?>
                    </div>
                    <div class="form-group col-md-4">
                         <?= $form->field($model, 'dataFimContrato')->textInput(['readonly'=>'true', 'value'=>$model->dataFimContrato]) ?>
                    </div>
                    <div class="form-group col-md-4">
                        <?= $form->field($model, 'periodoFidelizacao')->textInput(['readonly'=>'true', 'value'=>$model->periodoFidelizacao]) ?>
                    </div>
                </div>
              </div>
            </div>
        ...
        <div class="panel-group">
            <div class="panel panel-success">
              ...
              <div class="panel-body">
                   ...
                   <div class="form-row">
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'cartoesPosPago')->textInput(['readonly'=>'true', 'value'=>$model->cartoesPosPago]) ?>
                        </div>
                    
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'cartoesPrePago')->textInput(['readonly'=>'true', 'value'=>$model->cartoesPrePago]) ?>
                        </div>
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'totalCartoes')->textInput(['readonly'=>'true', 'value'=>$model->totalCartoes]) ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'valorPosPago')->textInput(['readonly'=>'true', 'value'=>$model->valorPosPago]) ?>
                        </div>
                    
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'valorPrePago')->textInput(['readonly'=>'true', 'value'=>$model->valorPrePago]) ?>
                        </div>
                        <div class="form-group col-md-4">
                            <?= $form->field($model, 'total')->textInput(['readonly'=>'true', 'value'=>$model->total]) ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
...
$script = <<< JS
    $(document).ready(function() {
        if ($("#totalQuantidadelId").val() === "") {
            $("#totalQuantidadelId").val(0);
        }
        if ($("#precoTotal").val() === "") {
            $("#precoTotal").val(0);
        }
